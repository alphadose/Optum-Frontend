  ...
  <d-navbar-nav class="border-left flex-row">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle text-nowrap px-3" v-d-toggle.user-actions>
        <img class="user-avatar rounded-circle mr-2" src="@/assets/images/avatars/profile.jpeg" alt="User Avatar"> <span class="d-none d-md-inline-block">Anish Mukherjee</span>
      </a>
